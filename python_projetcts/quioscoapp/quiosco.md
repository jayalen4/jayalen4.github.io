---
layout: default
title: Aplicación para tomar una foto parpadeando
description: Uso de la librería OpenCV
---

Para poder ejecutar correctamente este aplicativo, se necesita tener los archivos XML dentro de la carpeta del archivo .py. Asimismo, se hace uso de la librería tkinter para crear la interfaz gráfica del aplicativo.
...
class App(tk.Tk):
    def __init__(self):
        ...
        # -------------------------- frm 2 ----------------------------------
        self.btnPhoto = tk.Label(frm1, text="Cuando aparezca que se le ha detectado la cara, un cuadrado rojo estará" 
                                 "sobre su ojo derecho, parpadee para tomar la foto", width=100, command=None)
